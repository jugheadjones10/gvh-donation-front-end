export const strings = {
  ...
  ONEPENDINGANDNOCONFIRMED: "one pending and no confirmed",
  tallySuccessMessage:
    "Payment successful! We have emailed you your receipt. Please check the spam folder if you do not see the email.",
  morePendingMessage:
    "We are taking longer than usual to process your payment. Don't worry! We'll email you a receipt as soon as we can confirm your payment. If you are seeing this message even though you have not made a payment, please refresh the page and try again.",
  onePendingMessage:
