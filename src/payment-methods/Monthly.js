...
function Monthly({ classes, formikInitialValues, formikValidation, fetchFromFormServer }) {
        ...
        <Accordion>
            ...
            <AccordionDetails>
                ...
                {refid === null &&
                    ...
                    <form onSubmit={formik.handleSubmit} className={classes.container} id="monthlyform">
                        ...
                        <Amount className={classes.textField} formik={formik} label="Montly Donation Amount" />
...

            {
                ...
                <AccordionActions className={classes.container}>
                    <Button style={{ marginBottom: "20px" }} variant="contained" size="medium" color="primary" type="submit" form="monthlyform">Submit</Button>
                </AccordionActions>
            }
